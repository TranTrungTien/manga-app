                    ...
                    {notifications &&
                      ...
                      notifications.map((notification: any) => {
                        ...
                        return (
                          <li
                            // onClick={() =>
                            //   handleNavigateToCommentSection(notification)
                            // }
                          ...
                          >
                            <figure className="relative h-16 min-h-16 w-16 min-w-16 md:h-20 md:w-20 md:min-w-20">
                              <Image
                                layout="fill"
                                className="absolute inset-0 h-auto w-auto rounded-full"
                                alt="user-avatar"
                                src={notification.response.image}
                              />
                            </figure>
                            <h4
                              style={{
                              ...
                              className="line-clamp-3 flex-1 text-xl font-thin leading-7"
                            >
                              <span className="font-bold">
                                {notification.response.name}
                              </span>{' '}
                              đã trả lời bình luận của bạn trong{' '}
                              <span className="italic">
                                {notification.comment?.comicName}
                              </span>
                            </h4>
                          </li>
                        );
