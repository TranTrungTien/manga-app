    ...
    <li className="full-size flex max-h-[150px] min-h-[150px] w-full cursor-grab flex-col justify-between rounded-2xl bg-deep-black px-4 py-3">
      ...
      <div className="flex w-full space-x-4">
        ...
        <div className="flex max-w-[70%] flex-col">
          ...
          <h4 className="line-clamp-1 text-lg italic text-white/70">
      ...
      <p
        ...
        className={`${showSpoil ? '' : 'blur'} my-3 line-clamp-4 text-xl`}
      >
        {comment.contents}
      </p>
      {/* comic name  */}
      ...
      >
        <a>
          <h2 className="line-clamp-1 font-secondary text-2xl font-semibold text-primary">
            {comment.comicName}
          </h2>
        </a>
      </Link>
...
function RecentlyComments() {
  ...
  return (
    <ul className="text-white">
      <Swiper breakpoints={swiperBreakPoints} className="flex flex-col-reverse">
