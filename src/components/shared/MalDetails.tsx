    ...
    <div className="animate__fadeIn animate__animated grid h-fit w-full grid-cols-1 text-white md:grid-cols-2 md:space-x-2 lg:space-x-4">
      <div className="w-full">
        ...
        <div className="my-4 flex w-full flex-col space-y-2 md:space-y-4">
          <h1 className="font-secondary text-3xl md:text-4xl">Tên truyện:</h1>
          <h2 className="text-xl md:text-2xl">
            <span className="uppercase text-[#fb923c]">Tên khác:</span>{' '}
            {desc.titles?.title_synonyms || ''}
          </h2>
          <h2 className="text-xl md:text-2xl">
            <span className="uppercase text-[#22d3ee]">Japanese:</span>{' '}
            {desc.titles?.title_japanese || ''}
          </h2>
          <h2 className="text-xl md:text-2xl">
            <span className="uppercase text-[#f472b6]">English:</span>{' '}
            {desc.titles?.title_english || ''}
          </h2>
        </div>
        {/* desc  */}
        <div className="my-4 flex w-full flex-col space-y-2 md:space-y-4">
          <h1 className="font-secondary text-3xl md:text-4xl">Mô tả (MAL):</h1>
      ...
      <div className="w-full">
        <div className="my-4 flex w-full flex-col space-y-2 md:space-y-4">
          ...
          {/* score  */}
          <h1 className="font-secondary text-3xl md:text-4xl">Điểm (MAL):</h1>
