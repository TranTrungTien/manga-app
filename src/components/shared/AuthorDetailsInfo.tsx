    ...
    <div className="flex flex-col space-y-6">
      ...
      {author?.description && (
        <>
          ...
          <p className="text-xl md:max-w-[80%]">{author?.description}</p>
        </>
      )}
      ...
      <div className="flex w-full flex-wrap gap-x-6 gap-y-4">
        {author?.sc_twitter_link && (
          <button className="smooth-effect rounded-lg bg-highlight px-6 py-3 hover:bg-highlight/70">
            <a
              rel="noreferrer"
              target="_blank"
        ...
        {author?.sc_instagram_link && (
          <button className="smooth-effect flex items-center rounded-lg bg-highlight px-6 py-3 hover:bg-highlight/70">
            <a
              rel="noreferrer"
              target="_blank"
              className="flex items-center space-x-2"
