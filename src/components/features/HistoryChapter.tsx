  ...
  return (
    <Transition appear show={modalState} as={Fragment}>
      <Dialog as="div" className="relative z-[999]" onClose={handleCloseModal}>
        ...
        <div className="fixed left-1/2  top-1/2 -translate-x-1/2 -translate-y-1/2 lg:left-[calc(50%_+_150px)]">
              ...
              >
                <Dialog.Panel className="h-[350px] min-w-[300px] transform overflow-hidden rounded-2xl bg-background p-6 text-left align-middle shadow-xl transition-all lg:max-h-[85vh]">
                  <div className="flex items-center  justify-between text-white">
                    <Dialog.Title
                      as="h3"
                      className="mx-2 my-4 font-secondary text-3xl uppercase leading-6"
                    >
                      Tiếp tục đọc
                    </Dialog.Title>
                    <button
