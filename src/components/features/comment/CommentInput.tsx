...
import { FormEvent, memo, MouseEvent, RefObject, useState } from 'react';
...
function CommentInput({
  ...
  return (
    ...
    >
      ...
      <ul ref={animationParent} className="my-4 flex h-fit flex-wrap gap-4">
        {wordsSuggestion &&
          ...
          wordsSuggestion.map((word) => {
            ...
            return (
              <li
                ...
                className="line-clamp-1 max-h-[36px] max-w-[200px] cursor-pointer rounded-2xl border border-gray-500 px-4 py-2"
              >
                {word.word}
              </li>
            );
