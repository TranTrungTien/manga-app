  ...
  return (
    <Transition appear show={showModal} as={Fragment}>
      <Dialog as="div" className="relative z-[999]" onClose={handleCloseModal}>
        ...
        <div className="fixed left-0 right-0 top-1/2 -translate-y-1/2 overflow-y-auto">
            ...
            >
              <Dialog.Panel className="max-h-[70vh] w-[85%] transform overflow-x-hidden rounded-2xl bg-background p-6 text-left align-middle shadow-xl transition-all md:w-[75%] lg:max-h-[85vh]">
                <div className="flex items-center justify-between">
                  <Dialog.Title
                    as="h3"
                    className="mx-2 my-4 font-secondary text-2xl leading-6 text-white md:text-4xl"
                  >
                    Chapters:
                  </Dialog.Title>
                  <button
                ...
                <div className="my-4 flex flex-col">
                  <DetailsChapterList
                    ...
                    chapterList={
                      multipleSources?.chaptersDetail?.chapters?.[0]
                        .server_data || []
                    }
                  />
                </div>
