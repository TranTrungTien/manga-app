      ...
      >
        ...
        <div className="flex h-24 w-full items-center justify-between">
          ...
          <div className="absolute-center h-full w-72 md:w-80">
            ...
            <ToggleButton defaultState handleToggle={removeSection} />
          </div>
        </div>
        {/* slides  */}
        ...
        {comics && comics?.length
                ...
                <SwiperSlide key={comic._id}>
                  ...
                  >
                    <a className="full-size">
                      <div className="aspect-h-7 aspect-w-5 flex items-center overflow-hidden rounded-lg">
                        ...
                        <div
                          className={`flex h-full w-[30%] items-end justify-center bg-gradient-to-t ${
                            index === 0 && 'from-yellow-500 to-orange-300/70'
                          } ${index === 1 && 'from-gray-700 to-white/30'}  ${
                            index === 2 && 'from-orange-800 to-amber-100/50'
                          } ${
                            index > 2 && 'from-deep-black to-background/50 '
                          } pb-24 md:pb-32 lg:pb-44`}
                        >
                          <h1 className="line-clamp-1 min-w-[130px] -rotate-90 whitespace-nowrap text-xl md:min-w-[160px] md:text-2xl lg:min-w-[230px]">
                            #{++index} {comic?.name}
                          </h1>
                        </div>
                      </div>
          ...
          ? Array.from(new Array(8).keys()).map((e) => {
              return (
                <SwiperSlide key={e}>
                  <div className="loading-pulse aspect-h-7 aspect-w-5 flex items-center overflow-hidden rounded-lg bg-white/20"></div>
                </SwiperSlide>
              );
            })
          : null}
